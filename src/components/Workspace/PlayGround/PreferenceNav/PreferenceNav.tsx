...
const PreferenceNav:React.FC<PreferenceNavProps> = ({settings,setSettings}) => {
    ...
    return (
        <div className='flex items-center justify-between bg-dark-layer-2 h-11 w-full'>
            ...
            <button className='preferenceBtn group' onClick={()=>{
				setSettings({...settings,iconIsOpen:true})
			}}>
			...
			{settings.iconIsOpen && <SettingsModel settings={settings} setSettings={setSettings}/>}
        </div>
    )
}
